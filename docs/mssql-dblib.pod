$Header: /Perl/MSSQL/docs/mssql-dblib.pod 2     99-01-30 16:52 Sommar $
...
calling L</dblogin> or L</dbopen>. If you don't provide a server name,
DB-Library will apply its defaults. To use integrated security, call 
L</DBSETLSECURE> before calling L</dblogin> or L</dbopen>.
