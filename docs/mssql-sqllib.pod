$Header: /Perl/MSSQL/docs/mssql-sqllib.pod 2     99-01-30 16:52 Sommar $
...
To use integrated security, call the MSSQL::DBlib routine L</DBSETLSECURE>
before calling L</sql_init>.
...
Constants for DB-Library severities are defined in MSSQL::DBlib::Consts::Severity.
...
Constants for DB-Library errors are defined in MSSQL::DBlib::Consts::Errors.
